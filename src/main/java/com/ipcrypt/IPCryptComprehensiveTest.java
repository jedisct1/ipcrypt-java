...
public class IPCryptComprehensiveTest {
  ...
  private static void testAllVectors() throws Exception {
    ...
    assert encrypted1.getHostAddress().equals(expected1)
        : "ipcrypt-deterministic test 1 failed: expected "
            + expected1
            + ", got "
            + encrypted1.getHostAddress();
    ...
    byte[] key3 =
        IPCryptUtils.hexToBytes("0123456789abcdeffedcba98765432101032547698badcfeefcdab8967452301");
    ...
    assert encrypted4.getHostAddress().equals(expected4)
        : "ipcrypt-deterministic test 2 failed: expected "
            + expected4
            + ", got "
            + encrypted4.getHostAddress();
    ...
    byte[] key6 =
        IPCryptUtils.hexToBytes("1032547698badcfeefcdab89674523010123456789abcdeffedcba9876543210");
    ...
    assert encrypted7.getHostAddress().equals(expected7)
        : "ipcrypt-deterministic test 3 failed: expected "
            + expected7
            + ", got "
            + encrypted7.getHostAddress();
    ...
    byte[] key9 =
        IPCryptUtils.hexToBytes("2b7e151628aed2a6abf7158809cf4f3c3c4fcf098815f7aba6d2ae2816157e2b");
    ...
    assert encrypted10.getHostAddress().equals(expected10)
        : "ipcrypt-deterministic test 4 failed: expected "
            + expected10
            + ", got "
            + encrypted10.getHostAddress();
    ...
    assert encrypted13.getHostAddress().equals(expected13)
        : "ipcrypt-deterministic test 5 failed: expected "
            + expected13
            + ", got "
            + encrypted13.getHostAddress();
    ...
    assert decrypted7.getHostAddress().equals(ip7.getHostAddress())
        : "Deterministic decryption test failed: expected "
            + ip7.getHostAddress()
            + ", got "
            + decrypted7.getHostAddress();
    ...
    assert decrypted8.getHostAddress().equals(ip8.getHostAddress())
        : "ND decryption test failed: expected "
            + ip8.getHostAddress()
            + ", got "
            + decrypted8.getHostAddress();
    ...
    assert decrypted9.getHostAddress().equals(ip9.getHostAddress())
        : "NDX decryption test failed: expected "
            + ip9.getHostAddress()
            + ", got "
            + decrypted9.getHostAddress();
