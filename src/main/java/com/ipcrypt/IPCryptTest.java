...
public class IPCryptTest {
  ...
  private static void testDeterministic() throws Exception {
    ...
    assert decrypted3.getHostAddress().equals(ip3.getHostAddress())
        : "Decryption test failed: expected "
            + ip3.getHostAddress()
            + ", got "
            + decrypted3.getHostAddress();
  ...
  private static void testND() throws Exception {
    ...
    assert actual1.equals(expected1) : "Test 1 failed: expected " + expected1 + ", got " + actual1;
    System.out.println("Test 1 passed");
    ...
    assert actual2.equals(expected2) : "Test 2 failed: expected " + expected2 + ", got " + actual2;
    System.out.println("Test 2 passed");
    ...
    assert actual3.equals(expected3) : "Test 3 failed: expected " + expected3 + ", got " + actual3;
    System.out.println("Test 3 passed");
  ...
  private static void testNDX() throws Exception {
    ...
    assert actualCiphertext1.equals(expectedCiphertext1)
        : "Ciphertext test 1 failed: expected "
            + expectedCiphertext1
            + ", got "
            + actualCiphertext1;
    ...
    assert actualCiphertext2.equals(expectedCiphertext2)
        : "Ciphertext test 2 failed: expected "
            + expectedCiphertext2
            + ", got "
            + actualCiphertext2;
    ...
    assert actualCiphertext3.equals(expectedCiphertext3)
        : "Ciphertext test 3 failed: expected "
            + expectedCiphertext3
            + ", got "
            + actualCiphertext3;
